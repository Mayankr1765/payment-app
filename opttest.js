...
class Opt extends React.Component {
    ...
    handleClick = (name) => {
        ...
        switch(name){
            case "upi":
            this.setState({upi : !this.state.upi})
            break;
            case "dcard":
            this.setState({dcard: !this.state.dcard})
            break;
            default:
            console.log('bb');
        }
        ...
        return (
            ...
            <div>
                ...
                <div>
                    ...
                    >
                        ...
                        <ul className='col-12'><p className='text-left text-secondary pl-3'><strong>Prefered Payment Method</strong></p>
                            ...
                            <li
                                ...
                                onClick={()=> this.handleClick("dcard")}><i className="fa fa-credit-card"></i>  Debit Card</li>
                            <li className='btn btn-outline-primary col-12 mt-2 text-left'
                               y onClick={()=> this.handleClick("netbanking")}><i className="fa fa-university"></i> Net Banking</li>
                        </ul>
                        <ul className='col-12'><p className='text-left text-secondary pl-3'><strong>Other Payment Options</strong></p>
                            <li className='btn btn-outline-primary col-12 mt-2 text-left'
                                onClick={this.handleClick()}><i className="fa fa-folder-open"></i> Wallets</li>
                            <li
                                className='btn btn-outline-primary col-12  mt-2 text-left'
                                onClick={this.handleClick()}><i className="fa fa-credit-card"></i> Credit Card</li>
                    ...
                    {/* <h6 className='d-inline-block text-secondary mt-4 mb-4'>Powered by <img src="https://enalo.in/images/logo.svg" alt="img" height='35px' /></h6> */}
